...
* `semivisible`: switch to enable variables for semi-visible jets (default=0) (1 = scalars and AK8 jet properties; 2 = 1 + jet constituents + fractions; 3 = 1 + CA11 jets & scalars)
