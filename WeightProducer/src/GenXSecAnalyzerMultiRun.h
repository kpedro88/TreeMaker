...
#ifndef GenXSecAnalyzerMultiRun_H
#define GenXSecAnalyzerMultiRun_H
...
class GenXSecAnalyzerMultiRun : public edm::one::EDAnalyzer<edm::one::WatchRuns,edm::one::WatchLuminosityBlocks>{


public:
  explicit GenXSecAnalyzerMultiRun(const edm::ParameterSet&);
  ~GenXSecAnalyzerMultiRun() override;
