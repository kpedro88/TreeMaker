...
SVJsamples = [
    ...
    MCSample("step4_MINIAOD_SVJ_BFKKM_modelA_13TeV-pythia8_n-2000", "", "", "Constant", 41982),
    MCSample("step4_MINIAOD_SVJ_BFKKM_modelB_13TeV-pythia8_n-2000", "", "", "Constant", 21192),
]
